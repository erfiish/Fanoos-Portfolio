...
export const FAQ = () => {
  ...
  const faqItems = [
    {
              question: "خدمات هوش مصنوعی فانوس شامل چه مواردی است؟",
        answer: "ما در هوش مصنوعی فانوس طیف وسیعی از خدمات هوش مصنوعی شامل توسعه دستیارهای هوشمند، تحلیل داده، بهینه‌سازی فرآیندها با AI، و راه‌حل‌های سفارشی‌سازی شده برای کسب‌وکارها را ارائه می‌دهیم.",
    },
    {
              question: "هوش مصنوعی فانوس چه تفاوتی با سایر شرکت‌ها دارد؟",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-body text-gray-600 max-w-2xl mx-auto">
            پاسخ به پرتکرارترین سوالات شما درباره هوش مصنوعی فانوس
          </p>
        </motion.div>
